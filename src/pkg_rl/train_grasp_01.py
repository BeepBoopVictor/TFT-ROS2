...
def main():
    ...
    def make_cfg():
        return FP3DirectGraspRedEnvConfig(
            ...
            hard_reset_world_on_reset    = args.hard_reset_world_on_reset,
            hard_reset_settle            = args.hard_reset_settle,
            go_home_after_hard_reset     = args.go_home_after_hard_reset,
            hold_home_after_hard_reset   = args.hold_home_after_hard_reset,
